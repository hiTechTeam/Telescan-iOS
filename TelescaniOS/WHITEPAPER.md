...
- **Cache Limits**: Maximum 100 cached profiles
- **Automatic Cleanup**: Out-of-range devices removed immediately
- **Image Optimization**: Photos compressed and cached locally
...
Potential mesh features:

- **Profile Relaying**: Share profiles through intermediate devices
- **Extended Range**: Reach beyond direct BLE connectivity
- **Offline Operation**: Function without internet for discovery
- **Decentralized Storage**: Cache profiles on-device

### Advanced Privacy

- **Zero-Knowledge Proofs**: Prove profile ownership without revealing data
- **Anonymous Routing**: Multi-hop profile requests
- **Temporal IDs**: Rotating identifiers for enhanced privacy
